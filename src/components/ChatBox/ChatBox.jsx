    ...
    <div className='shadow font-primary px-[50px] py-[24px] rounded-[20px]'>
            ...
            messageList.map((item) => (
              ...
              <div className='my-2 text-end'>
                <div className='relative'>
                  <p className='px-[52px] py-[13px] bg-primary inline-block font-medium 
          text-[16px] rounded-[10px] text-white'>{item?.message}</p>
              ...
              <div className='my-2'>
          <div className='relative'>
          <p className='px-[52px] py-[13px] bg-[#F1F1F1] inline-block font-medium 
          text-[16px] rounded-[10px]'>{item?.message}</p>
      ...
      <div className="w-full flex justify-between items-center mt-[35px]">
          ...
          <div className="flex items-center gap-3">
            {
             ...
             <div
              ...
              <MdOutlineEmojiEmotions className="text-[20px] text-black/50" />
             </div>
            }
        ...
        <div
          ...
          className="bg-black p-3 rounded-[10px] ml-3">
