        ...
        <div className='flex justify-between items-center mt-[17px] border-b-2 border-[#b0a9a9] pb-[10px]'>
          <div className='flex items-center'>
            ...
            <div className='ml-[14px]'>
              ...
              <p className='font-medium text-[12px] text-[#4D4D4D]'>Sure!</p>
            </div>
          </div>
          <p className='font-medium text-[12px] text-[#4D4D4D]'>Today, 2:31pm</p>
        </div>
        <div className='flex justify-between items-center mt-[17px] border-b-2 border-[#b0a9a9] pb-[10px]'>
          <div className='flex items-center'>
            ...
            <div className='ml-[14px]'>
              ...
              <p className='font-medium text-[12px] text-[#4D4D4D]'>Hi.....</p>
            </div>
          </div>
          <p className='font-medium text-[12px] text-[#4D4D4D]'>Yesterday, 6:22pm</p>
        </div>
        <div className='flex justify-between items-center mt-[17px] border-b-2 border-[#b0a9a9] pb-[10px]'>
          <div className='flex items-center'>
            ...
            <div className='ml-[14px]'>
              ...
              <p className='font-medium text-[12px] text-[#4D4D4D]'>I will call him today.</p>
            </div>
          </div>
          <p className='font-medium text-[12px] text-[#4D4D4D]'>Today, 12:22pm</p>
        </div>
        <div className='flex justify-between items-center mt-[17px] border-b-2 border-[#b0a9a9] pb-[10px]'>
          <div className='flex items-center'>
            <img src={friends1} alt="#friends1" />
