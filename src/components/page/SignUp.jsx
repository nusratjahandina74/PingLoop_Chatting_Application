                ...
                <div className='flex justify-end mr-[70px]'>
                    <div>
                        ...
                        <div className='relative w-[368px] mt-[53px]'>
                            ...
                            className='w-full py-[20px] pr-[66px] pl-[38px] border-2 border-[#11175D] rounded-[8px]' type="email" placeholder='Email Address' />
                        ...
                        <div className='relative w-[368px] mt-[53px]'>
                            ...
                            className='w-full py-[20px] pr-[66px] pl-[38px] border-2 border-[#11175D] rounded-[8px]' type="text" placeholder='Full Name' />
                        ...
                        <div className='relative w-[368px] mt-[53px]'>
                            ...
                            className='w-full py-[20px] pr-[66px] pl-[38px] border-2 border-[#11175D] rounded-[8px]' type="text" placeholder='. . . . . . . . .' />
